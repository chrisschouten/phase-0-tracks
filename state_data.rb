...
# require_relative allows our program refer to another file regardless of the directory its in.
# require used for gem - ruby library

class VirusPredictor

  # setting up each instance with variables attributes .new = initialize
  ...
  # returning the two methods being called inside the method
  def virus_effects
    predicted_deaths
    speed_of_spread
  end
  ...
  # it calculates predicted deaths based density and population
  ...
  # predicting the speed at which the virus will spread based on population densitiy. 
...
# iterate thru state data hashy hasy and inside the iteration we will call the class which will call each itmen in the hashy hash
